...
def fcn2s_description(features, labels, params, mode, config):
    ...
    up_score_4 = layers.up_conv_add_layer(up_score_3, pool1, params=params, kernel_size=4,
                                          num_filters=num_classes, strides=2, pad="same", name="4")

    up_final = layers.up_conv_layer(up_score_4, num_filters=num_classes, kernel_size=8, strides=2,
